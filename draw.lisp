...
(defun just-say-lisp2 (&optional (font-name "fixed"))
  (let* ((display   (open-default-display))
    ...
    (unwind-protect
	(do (choice)
	    ((and (setf choice (menu-choose a-menu 2000 100))
...
(defun menu-draw-point (menu x y)
    ;; Draw a point
    (DRAW-POINT (menu-window menu)
		    (menu-gcontext menu)
                    x y))
